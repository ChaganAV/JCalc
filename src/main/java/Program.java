...
public class Program {
    public static void main(String[] args) {
        ...
        int value1 = 3;
        double value2 = 3.4;
        System.out.println(Calculation.sum(value1,value2));
        System.out.println(Calculation.multiply(value1,value2));
        System.out.println(Calculation.divide(value1,value2));
        System.out.println(Calculation.subtract(value1,value2));
        // compareArray
